...
import { Calendar, User, Eye, BookOpen, Music, Palette, Camera } from 'lucide-react';
          ...
          >
            <div className="heritage-card oasis-gradient text-white max-w-2xl mx-auto">
              ...
              <Button
                ...
                className="bg-black text-[var(--oasis-blue)] hover:bg-[var(--sand-light)] px-8 py-3 modern-font"
              >
                شارك محتواك
              </Button>
            </div>
