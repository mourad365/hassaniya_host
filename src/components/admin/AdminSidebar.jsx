...
const AdminSidebar = () => {
  ...
  return (
    <aside className="w-full lg:w-64 bg-sand-light text-[var(--tent-black)] p-4 lg:p-6 flex flex-col justify-between border-b lg:border-b-0 lg:border-l border-[var(--sand-dark)]">
      <div>
